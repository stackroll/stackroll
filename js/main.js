document.addEventListener('DOMContentLoaded', () => {
  ...
  if (cursor && cursorRing && window.matchMedia('(hover: hover)').matches) {
    ...
    const hoverEls = document.querySelectorAll('a, button, .hover-target, [data-cursor]');
    hoverEls.forEach(el => {
  ...
  document.querySelectorAll('a[href]').forEach(link => {
    ...
    if (href && (href.startsWith('/') || href.endsWith('.html')) && !href.startsWith('//') && !href.startsWith('mailto:')) {
